...
app.put('/episodios', (req, res) => {
  ...
  const episodioExistente = episodios.find(episodio => episodio.id === parseInt(episodioActualizado.id));
...
const planetas = [
    ...
    },
    {
        ...
        "descripcion": "Earth es el planeta dónde reside la raza humana y la ubicación principal de los personajes del show. Este planeta tiene sobre 4.6 millones de años, se encuentra en el Sistema Solar y es el tercer planeta hacia el Sol. Solo tiene un satélite natural."
    },
    {
        "id": 67,
        ...
        "descripcion": "Blips and Chitz es un arcade intergaláctico. Su ubicación es desconocida, pero se puede ver que está en un espacio más que en un planeta."
    }
]
...
app.put('/personajes', (req, res) => {
    ...
    // Ejemplo de actualización en un array en memoria
    const personajeExistente = personajes.find(personaje => personaje.id === parseInt(personajeActualizado.id));
